...
// struct UpdateAccessory : Service::Switch {
//   SpanCharacteristic *updateAvailable;
//   SpanCharacteristic *updateNow;

//   UpdateAccessory() : Service::Switch() {
//     updateAvailable = new Characteristic::On(false);  // shows update status
//     updateNow = new Characteristic::On(false);        // user confirms
//   }

//   boolean update() override {
//     if (updateNow->getNewVal()) {
//       Serial.println("User confirmed update!");
//       httpUpdate();   // run OTA update function
//       updateNow->setVal(false);  // reset switch
//     }
//     return true;
//   }
...
//         updateAvailable->setVal(true);
//         Serial.println("Update available!");
//       } else {
//         updateAvailable->setVal(false);
//       }
//     }
//   }
// };
...
struct UpdateAvailableSensor : Service::MotionSensor {
  ...
  void loop() override {
    if (checkUpdateAvailable()) {
      ...
      motionChar->setVal(false); // no update
    }
  }
};
